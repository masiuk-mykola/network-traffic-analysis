...
| #   | Commit                                  | What                                                                                                                                                                                                                                                                                                         |
| --- | --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2.1 | ✅ done                                 | The capture points this account may read, with the lagging one marked, and a time window derived from the last traffic those points reported rather than from the clock — this capture ends in the past. The query lives in the address bar from here on. Still to drop: the temporary `/dev/session` probe. |
