...
| #   | Commit                                      | What                                                                                                                                                                                                                                                                                   |
| --- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2.1 | `feat(search): add the query form`          | Capture points from `/v1/sensors` (1–5) and a time window. Validation before anything is sent. Drop the temporary `/dev/session` probe once this screen reads for real.                                                                                                                |
