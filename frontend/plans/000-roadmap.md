...
| #   | Commit                               | What                                                                                                                                                                                                                                                                                                                                                                                                                              | Scored                                                   |
| --- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| 6.1 | ✅ done                              | The feed on a screen of its own, each detection leading to its session. One connection per session, held on the server because the API grades opens per token family and two tabs are one family; every re-open carries a resume point and waits first. Three storm runs: `sse.double_open`, `sse.reconnect_backoff`, `sse.resume` 100 % — 0 fail. Proved by `npm run gate:detection-resume`, beside the suite rather than in it. | `sse.double_open`, `sse.resume`, `sse.reconnect_backoff` |
